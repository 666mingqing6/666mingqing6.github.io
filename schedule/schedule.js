/* =====================================================================
 * 日历 + 进度条侧边栏卡片脚本（AnZhiYu 主题适配版）
 * 教程来源：https://everfu.github.io/solitude-demo/posts/874ddadb.html
 * 依赖：chinese-lunar.js（公历转农历，通过 CDN 引入）
 * 适配说明：HTML 卡片由 custom.js 注入到 #aside-content，本脚本只负责数据填充
 * ===================================================================== */
...
function cardTimes() {
  ...
  if (e) {
    ...
    if (scheduleDaysEl) scheduleDaysEl.innerHTML = daysUntilNewYear;
  }
}
